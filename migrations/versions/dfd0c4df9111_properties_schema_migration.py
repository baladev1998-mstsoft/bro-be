...
Revision ID: dfd0c4df9111
Revises: 5f95f41cee00
Create Date: 2025-12-05 13:26:40.153081
...
revision = 'dfd0c4df9111'
down_revision = '5f95f41cee00'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('properties', sa.Column('starting_price', sa.Numeric(precision=12, scale=2), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('properties', 'map_url')
    ...
    op.drop_column('properties', 'starting_price')
